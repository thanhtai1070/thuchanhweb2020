			...
			<div class="row">
				<div class="col-12" >
					<ul class="list__menu" >
						...
						<li><a href="index.php?quanly=ql_tacgia">Quản lí tác giả</a></li>
						<li><a href="index.php?quanly=ql_ncc">Quản lí nhà cung cấp</a></li>
						<li><a href="index.php?quanly=ql_nxb">Quản lí nhà xuất bản</a></li>
